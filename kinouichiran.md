...
|1-4|合計金額|ショッピングカート内の商品の<br>合計金額を表示||||
|1-5|会員登録|ID、パスワード、氏名、住所、電話<br>番号、メールアドレスを入力し、登録する|○|||
|1-6|ログイン|登録しているIDとパスワードを<br>入力してログインする|○|||
|1-7|会員情報編集|登録している会員情報を<br>いつでも変更する||||
